...
void struct_test_qshan(void)
{
  ...
  std::cout << "start of " << __func__ << " in " << __FILE__ <<  std::endl <<  std::endl;
  ...
  std::cout << "Check the member value " << std::endl;
  std::cout << test_struct_test_qshan.name << " " << test_struct_test_qshan.old << std::endl;
#endif
  ...
  test_struct_test_qshan1.name = "Xiaoxiao1";
  test_struct_test_qshan1.old = 16;
  test_struct_test_qshan1.job = "Student";

  std::cout << "Check the member value " << std::endl;
  std::cout << test_struct_test_qshan1.name << " " << test_struct_test_qshan1.old << std::endl;
#endif
  ...
  StructTestQshan2 test_struct_test_qshan2;

  test_struct_test_qshan2.name = "Xiaoxiao2";
  test_struct_test_qshan2.old = 18;
  test_struct_test_qshan2.job = "Student";

  std::cout << "Check the member value " << std::endl;
  std::cout << test_struct_test_qshan2.name << " " << test_struct_test_qshan2.old << std::endl;
#endif
